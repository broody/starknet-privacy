...
pub mod Privacy {
    ...
    use privacy::objects::{
        ContractNote, ContractNoteContext, EncChannelInfo, EncOutgoingChannelInfo, EncPrivateKey,
        EncSubchannelInfo, Note, OpenNoteDeposit, OpenNoteScreeningPolicy, TokenBalances,
        TokenBalancesTrait,
    };
