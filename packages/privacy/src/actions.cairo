...
pub struct ControlledInvokeInput {
    pub controller: ContractAddress,
    /// Public receipt returned by the controller's proof-time validation entrypoint. It must never
    /// contain private transition data such as note amounts or spend keys.
    pub public_authorization: Span<felt252>,
