...
pub const ZERO_CONTROLLED_NOTE_SPEND_KEY: felt252 = 'ZERO_CONTROLLED_SPEND_KEY';
pub const ZERO_NOTE_ID: felt252 = 'ZERO_NOTE_ID';
pub const CONTROLLED_NOTE_NOT_FOUND: felt252 = 'CONTROLLED_NOTE_NOT_FOUND';
pub const INVALID_CONTROLLED_NOTE_OPENING: felt252 = 'INVALID_CONTROLLED_OPENING';
pub const CONTROLLED_NOTE_AUTHORIZATION_REQUIRED: felt252 = 'CONTROLLED_AUTH_REQUIRED';
pub const CONTROLLED_NOTE_TARGET_MISMATCH: felt252 = 'CONTROLLED_TARGET_MISMATCH';
pub const MULTIPLE_CONTROLLED_TARGETS: felt252 = 'MULTIPLE_CONTROL_TARGETS';
pub const INVALID_CONTROLLED_CONTEXT: felt252 = 'INVALID_CONTROLLED_CONTEXT';
pub const INVALID_CONTROLLED_AUTHORIZATION: felt252 = 'INVALID_CONTROLLED_AUTH';
pub const CONTROLLED_OPEN_OUTPUT_UNSUPPORTED: felt252 = 'CONTROLLED_OPEN_UNSUPPORTED';
