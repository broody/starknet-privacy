...
pub const ZERO_CONTROLLER_CONTRACT: felt252 = 'ZERO_CONTROLLER_CONTRACT';
pub const ZERO_CONTROLLER_COMMITMENT: felt252 = 'ZERO_CONTROLLER_COMMITMENT';
pub const ZERO_CONTRACT_NOTE_NONCE: felt252 = 'ZERO_CONTRACT_NOTE_NONCE';
pub const ZERO_CONTRACT_NOTE_BLINDING: felt252 = 'ZERO_CONTRACT_NOTE_BLINDING';
pub const ZERO_NOTE_ID: felt252 = 'ZERO_NOTE_ID';
pub const CONTRACT_NOTE_NOT_FOUND: felt252 = 'CONTRACT_NOTE_NOT_FOUND';
pub const INVALID_CONTRACT_NOTE_OPENING: felt252 = 'INVALID_CONTRACT_NOTE_OPENING';
pub const CONTRACT_NOTE_CALLBACK_REQUIRED: felt252 = 'CONTRACT_NOTE_CALLBACK_REQUIRED';
pub const CONTRACT_NOTE_TARGET_MISMATCH: felt252 = 'CONTRACT_NOTE_TARGET_MISMATCH';
pub const CONTROLLER_CLASS_MISMATCH: felt252 = 'CONTROLLER_CLASS_MISMATCH';
pub const MULTIPLE_NOTE_CONTROLLERS: felt252 = 'MULTIPLE_NOTE_CONTROLLERS';
