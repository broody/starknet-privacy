...
pub const ZERO_PREDICATE_ADDRESS: felt252 = 'ZERO_PREDICATE_ADDRESS';
pub const ZERO_PREDICATE_COMMITMENT: felt252 = 'ZERO_PREDICATE_COMMITMENT';
pub const ZERO_PREDICATE_NONCE: felt252 = 'ZERO_PREDICATE_NONCE';
pub const ZERO_PREDICATE_BLINDING: felt252 = 'ZERO_PREDICATE_BLINDING';
pub const ZERO_NOTE_ID: felt252 = 'ZERO_NOTE_ID';
pub const PREDICATE_NOTE_NOT_FOUND: felt252 = 'PRED_NOTE_NOT_FOUND';
pub const INVALID_PREDICATE_OPENING: felt252 = 'INVALID_PRED_OPENING';
pub const PREDICATE_CALLBACK_REQUIRED: felt252 = 'PRED_CALLBACK_REQUIRED';
pub const PREDICATE_TARGET_MISMATCH: felt252 = 'PRED_TARGET_MISMATCH';
pub const PREDICATE_CLASS_MISMATCH: felt252 = 'PRED_CLASS_MISMATCH';
pub const MULTIPLE_PREDICATES: felt252 = 'MULTIPLE_PREDICATES';
