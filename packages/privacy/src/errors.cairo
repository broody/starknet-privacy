...
pub const ZERO_POLICY_COMMITMENT: felt252 = 'ZERO_POLICY_COMMITMENT';
pub const ZERO_ESCROW_NOTE_SECRET: felt252 = 'ZERO_ESCROW_NOTE_SECRET';
pub const ZERO_NOTE_ID: felt252 = 'ZERO_NOTE_ID';
pub const ESCROW_NOTE_NOT_FOUND: felt252 = 'ESCROW_NOTE_NOT_FOUND';
pub const INVALID_ESCROW_NOTE_OPENING: felt252 = 'INVALID_ESCROW_NOTE_OPENING';
pub const ESCROW_NOTE_CALLBACK_REQUIRED: felt252 = 'ESCROW_NOTE_CALLBACK_REQUIRED';
pub const ESCROW_NOTE_TARGET_MISMATCH: felt252 = 'ESCROW_NOTE_TARGET_MISMATCH';
pub const MULTIPLE_ESCROW_TARGETS: felt252 = 'MULTIPLE_ESCROW_TARGETS';
pub const INVALID_ESCROW_NOTE_CONTEXT: felt252 = 'INVALID_ESCROW_NOTE_CONTEXT';
pub const OPEN_ESCROW_NOTE_NOT_FOUND: felt252 = 'OPEN_ESCROW_NOTE_NOT_FOUND';
pub const OPEN_ESCROW_NOTE_NOT_FUNDED: felt252 = 'OPEN_ESCROW_NOTE_NOT_FUNDED';
pub const OPEN_ESCROW_NOTE_ALREADY_FUNDED: felt252 = 'OPEN_ESCROW_NOTE_ALREADY_FUNDED';
pub const INVALID_OPEN_ESCROW_NOTE_OPENING: felt252 = 'INVALID_OPEN_ESCROW_OPENING';
pub const OPEN_ESCROW_NOTE_TARGET_MISMATCH: felt252 = 'OPEN_ESCROW_TARGET_MISMATCH';
pub const UNDEPOSITED_OPEN_ESCROW_NOTES: felt252 = 'UNDEPOSITED_OPEN_ESCROWS';
...
pub(crate) mod internal_errors {
    ...
    pub const TOO_MANY_OPEN_ESCROWS_DEPOSITED: felt252 = 'TOO_MANY_OPEN_ESCROWS_DEPOSITED';
}
