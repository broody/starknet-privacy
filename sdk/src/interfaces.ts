...
export type ControlledNoteCreation = {
  ...
  amount: Amount;
  /** Bearer capability retained or distributed according to the application's private policy. */
...
export interface TokenOperationsBuilder {
   ...
   * capability over which the controller may enforce additional policy. The same transaction must
   * invoke the controller to authorize creation.
   */
